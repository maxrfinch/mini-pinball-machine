...
typedef enum {
    ...
    DISPLAY_ANIM_ICED_UP,
    DISPLAY_ANIM_MULTIBALL_DAZZLE,
    DISPLAY_ANIM_CENTER_WATERFALL,
    DISPLAY_ANIM_WATER_RIPPLE,
    DISPLAY_ANIM_GAME_OVER_CURTAIN,
    DISPLAY_ANIM_HIGH_SCORE,
    DISPLAY_ANIM_ATTRACT_PINBALL
} DisplayAnimation;
